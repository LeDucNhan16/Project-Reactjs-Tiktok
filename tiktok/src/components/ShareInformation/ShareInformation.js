...
import styles from "./ShareInformation.module.scss";
import {
  BirdIcon,
  CopyIcon,
  FacebookIcon,
  ...
  return (
    <div className={cx("wrapper__tippy")}>
      <Link className={cx("wrapper__tippy__items")}>
        <TagSyntaxIcon className={cx("share__subIcon")} />
        <span>Embed</span>
      </Link>
      <Link className={cx("wrapper__tippy__items")}>
        <PlaneRedIcon className={cx("share__subIcon")} />
        <span>Send to friends</span>
      </Link>
      <Link
        to="https://www.facebook.com/sharer"
        className={cx("wrapper__tippy__items")}
      >
        <FacebookIcon className={cx("share__subIcon")} />
        <span>Send to Facebook</span>
      </Link>
      <Link
        to="https://api.whatsapp.com/send/?text=https%3A%2F%2Fwww.tiktok.com%2F%40mon_roseee%2Fvideo%2F7240449581362760965%3Fis_from_webapp%3D1%26sender_device%3Dpc&type=custom_url&app_absent=0"
        className={cx("wrapper__tippy__items")}
      >
        <PhoneIcon className={cx("share__subIcon")} />
      ...
      <Link
        to="https://twitter.com/intent/tweet?refer_source=https%3A%2F%2Fwww.tiktok.com%2F%40mon_roseee%2Fvideo%2F7240449581362760965%3Fis_from_webapp%3D1%26sender_device%3Dpc&text=https%3A%2F%2Fwww.tiktok.com%2F%40mon_roseee%2Fvideo%2F7240449581362760965%3Fis_from_webapp%3D1%26sender_device%3Dpc"
        className={cx("wrapper__tippy__items")}
      >
        <BirdIcon className={cx("share__subIcon")} />
