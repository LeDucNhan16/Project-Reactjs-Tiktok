  ...
  },
  {
    ...
    children: {
      ...
      data: [
        ...
        {
          title: "Tắt tiếng/Mở tiếng video",
          id: "4",
  ...
  return (
    <header className={cx("wrapper")}>
      <div className={cx("inner")}>
        {/* Logo header */}
        <Link className={cx("logo")} to={config.routers.Home}>
        ...
        <div className={cx("actions")}>
          ...
          {currentResult ? (
            <Menu items={MENU_ITEMS_LOGIN}>
              <Image
                src="https://tse3.mm.bing.net/th?id=OIP.cLFYh5JgUcvbxNL4oz9WjAHaGF&pid=Api&P=0"
                className={cx("use_avatar")}
                alt="avatar"
                fallback="https://tse4.mm.bing.net/th?id=OIP.5fjVI_rbqFKLTgo2JfMjogHaFj&pid=Api&P=0"
              />
            </Menu>
          ) : (
